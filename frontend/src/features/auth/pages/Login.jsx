...
import ecommerceOutlookAnimation from "../../../assets/animations/ecommerceOutlook.json";
import shoppingBagAnimation from "../../../assets/animations/shoppingBag.json";
import {useDispatch,useSelector} from 'react-redux'
// import { LoadingButton } from '@mui/lab';
import {selectLoggedInUser,loginAsync,selectLoginStatus, selectLoginError, clearLoginError, resetLoginStatus} from '../slice/AuthSlice'
    ...
    >
      {!is900 && (
        <Stack bgcolor={"black"} flex={1} justifyContent={"center"}>
          <Lottie
            key="login-animation"
            // Force Vite to read the raw JSON, not the module object
            animationData={
              ecommerceOutlookAnimation.default || ecommerceOutlookAnimation
            }
          />
        </Stack>
      )}
