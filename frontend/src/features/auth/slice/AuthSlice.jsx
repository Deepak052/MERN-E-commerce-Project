...
// 🚨 FIX: Added rejectWithValue to ALL thunks to properly catch 401/404 Backend errors
export const signupAsync = createAsyncThunk(
  "auth/signupAsync",
  async (cred, { rejectWithValue }) => {
    try {
      return await signup(cred);
    } catch (error) {
...
export const forgotPasswordAsync = createAsyncThunk(
  ...
  async (cred, { rejectWithValue }) => {
    try {
      return await forgotPassword(cred);
    } catch (error) {
      return rejectWithValue(error);
    }
  },
...
export const resetPasswordAsync = createAsyncThunk(
  ...
  async (cred, { rejectWithValue }) => {
    try {
      return await resetPassword(cred);
    } catch (error) {
      return rejectWithValue(error);
    }
  },
...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      // 🚨 FIX: Corrected typo "fullfilled" -> "fulfilled" across all cases
      ...
      .addCase(signupAsync.rejected, (state, action) => {
        ...
        state.signupError = action.payload || action.error;
      })
      ...
      .addCase(verifyOtpAsync.rejected, (state, action) => {
        ...
        state.otpVerificationError = action.payload || action.error;
      })
      ...
      .addCase(resendOtpAsync.rejected, (state, action) => {
        ...
        state.resendOtpError = action.payload || action.error;
      })
...
// Selectors & Exports remain exactly the same...
